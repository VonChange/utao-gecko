...
public class TestActivity extends Activity {
    ...
    private void bind(){
        ...
        detailMenu2.getNow().getXj().setTitle("XXXXXXXX");
    ...
    private void focusChange(ActivityTestBinding binding) {
        View view = findViewById(R.id.tvMenu);
        view.getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserver.OnGlobalFocusChangeListener() {
            ...
            public void onGlobalFocusChanged(View oldFocus, View newFocus) {
                ...
                switch (tag){
                    case "hzItem":
                        //focusBtn.setNextFocusDownId(R.id.hzs_view);
                        //binding.hzsView.getChildAt(0).requestFocus();
                        focusBtn.setNextFocusUpId(R.id.hzBtn);
                        break;
                    case "rateItem":
                        //focusBtn.setNextFocusDownId(R.id.rates_view);
                    ...
                    case "xjItem":
                        ...
                        String oldTag=oldBtnTag(oldFocus);
                        if(null!=oldFocus){
                       ...
                       // int count= binding.xjsView.getLayoutManager().getItemCount();
                       // Log.d(TAG, "xjItem: count=" + count);
                       // binding.xjsView.getLayoutManager().findViewByPosition(3).requestFocus();
                        //focusBtn.setNextFocusDownId(R.id.xjs_view);
                        break;
                    default:
